...
// PhysTask.cpp: определяет поведение классов для приложения.
//
...
BEGIN_MESSAGE_MAP(CPhysTaskApp, CWinApp)
	ON_COMMAND(ID_HELP, &CWinApp::OnHelp)
END_MESSAGE_MAP()


// Создание CPhysTaskApp

CPhysTaskApp::CPhysTaskApp()
{
...
// Единственный объект CPhysTaskApp

CPhysTaskApp theApp;


// Инициализация CPhysTaskApp

BOOL CPhysTaskApp::InitInstance()
{
